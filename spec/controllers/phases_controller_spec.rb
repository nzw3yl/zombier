...
describe PhasesController do
  ...
  let(:valid_attributes) { { "title" => "MyString", "project_id" => project.id } }
  ...
  describe "GET show" do
    it "assigns the requested phase as @phase" do
      phase = Phase.create! valid_attributes
      get :show, {:id => phase.to_param, :project_id => project.id }, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested phase as @phase" do
      phase = Phase.create! valid_attributes
      get :edit, {:id => phase.to_param, :project_id => project.id }, valid_session
      assigns(:phase).should eq(phase)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Phase" do
        expect {
          post :create, {:phase => valid_attributes , :project_id => project.id  }, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved phase as @phase" do
        ...
        post :create, {:phase => { "title" => "invalid value"}, :project_id => project.id }, valid_session
        assigns(:phase).should be_a_new(Phase)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested phase" do
        ...
        Phase.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => phase.to_param, :phase => { "title" => "MyString"}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the phase as @phase" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Phase.any_instance.stub(:save).and_return(false)
        put :update, {:id => phase.to_param, :phase => { "title" => "invalid value" }}, valid_session
        assigns(:phase).should eq(phase)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested phase" do
      phase = Phase.create! valid_attributes
      expect {
        delete :destroy, {:id => phase.to_param, :project_id => project.id}, valid_session
      }.to change(Phase, :count).by(-1)
    end
    ...
    it "redirects to the phases list" do
      phase = Phase.create! valid_attributes
      delete :destroy, {:id => phase.to_param, :project_id => project.id}, valid_session
      response.should redirect_to(project_phases_url(project))
    end
  end
